...
const PublicReport = () => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground font-medium">Loading Authentic Report Snapshot...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-white">
      {/* Header */}
      <div className="bg-[#0B3D91] text-primary-foreground">
      ...
      <div className="max-w-3xl mx-auto px-4 py-6 space-y-5">
        ...
        <div className="bg-card rounded-xl shadow-sm border border-border p-5">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h2 className="text-xl font-bold text-foreground">{workerName}</h2>
              <p className="text-sm text-muted-foreground">{skill} | {location}</p>
              <p className="text-xs text-muted-foreground mt-1">Aadhaar: {maskedPhone}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl shadow-sm border border-border p-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-muted rounded-lg p-3 border border-border">
              <p className="text-xs text-muted-foreground mb-1">Monthly Income Range</p>
              <p className="text-base font-bold text-foreground">INR {incomeMin.toLocaleString()} - {incomeMax.toLocaleString()}</p>
            </div>
            <div className="bg-muted rounded-lg p-3 border border-border">
          ...
          <div className="bg-card rounded-xl shadow-sm border border-border p-5">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-[#0B3D91] text-primary-foreground text-xs">
                ...
                <tbody>
                  {recentJobs.slice(0, 5).map((v: any, i: number) => (
                    <tr key={i} className={`${i % 2 === 0 ? 'bg-muted' : 'bg-card'} border-b border-border`}>
